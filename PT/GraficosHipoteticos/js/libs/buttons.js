...
$(document).ready(function () {
	...
	arr.forEach(function(d,i){
		switch(i) {
		  	case 0:
		  		d4= geraperguntas(novodataset[0],d,4);
		  		list = document.getElementById("21p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		  	case 1:
		  		d4= geraperguntas(novodataset[1],d,4);
		  		list = document.getElementById("22p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		  	case 2:
		  		d4= geraperguntas(novodataset[2],d,4);
		  		list = document.getElementById("23p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 3:
		  		d4= geraperguntas(novodataset[3],d,4);
		  		list = document.getElementById("24p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 4:
		  		d4= geraperguntas(novodataset[4],d,4);
		  		list = document.getElementById("25p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 5:
		  		d4= geraperguntas(novodataset[5],d,4);
		  		list = document.getElementById("26p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 6:
		  		d4= geraperguntas(novodataset[6],d,4);
		  		list = document.getElementById("27p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 7:
		  		d4= geraperguntas(novodataset[7],d,4);
		  		list = document.getElementById("28p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 8:
		  		d4= geraperguntas(novodataset[8],d,4);
		  		list = document.getElementById("29p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 9:
		  		d4= geraperguntas(novodataset[9],d,4);
		  		list = document.getElementById("30p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 10:
		  		d4= geraperguntas(novodataset[10],d,4);
		  		list = document.getElementById("31p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 11:
		  		d4= geraperguntas(novodataset[11],d,4);
		  		list = document.getElementById("32p");
				list.insertBefore(d4, list.childNodes[0]);
		    break;
		    case 12:
		  		d4= geraperguntas(novodataset[12],d,4);
