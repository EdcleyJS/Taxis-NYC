...
var mapVis03 = L.map('vis03').setView([40.752866,-73.986023], 13);
var mapDot = L.map('vis3').setView([40.752866,-73.986023], 13);
var gradesDot=[43,6000,12000,18000,24000,30000,36000,42000,54469];
  ...
  L.geoJson(dataset,{
    onEachFeature: async function (feature, layer) {
        ...
        novaDist.forEach(function(d){
          ...
          for (i; i<l; i++) {
              if (pdisponiveis>0) {
                dots.push(L.circleMarker(pointsGrid[i], {radius: 1.6, weight: 1,fillColor: cor,fillOpacity:1, color: cor,renderer: myRenderer}));
